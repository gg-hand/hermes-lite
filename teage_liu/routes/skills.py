...
from teage_liu.app import get_skill_loader, get_orchestrator
...
def _get_skill_state_path() -> str:
    """获取 SKILL_STATE_PATH（兼容测试 patch teage_liu.server.SKILL_STATE_PATH）。"""
...
from teage_liu.skill.loader import load_skill_to_registry, register_skill_stub
from teage_liu.agent.skill_tools import _make_skill_activate_handler
@router.get("/skills")
