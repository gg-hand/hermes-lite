...
async def lifespan(app: FastAPI):
    ...
    """
    from teage_liu.lifespan import lifespan as _lifespan
...
from teage_liu.config_helpers import _RESTART_REQUIRED_KEYS  # noqa: E402
...
from teage_liu.routes.misc import router as misc_router  # noqa: E402
from teage_liu.routes.health import router as health_router  # noqa: E402
from teage_liu.routes.sessions import router as sessions_router  # noqa: E402
from teage_liu.routes.config import router as config_router  # noqa: E402
from teage_liu.routes.approvals import router as approvals_router  # noqa: E402
from teage_liu.routes.proposals import router as proposals_router  # noqa: E402
from teage_liu.routes.skills import router as skills_router  # noqa: E402
from teage_liu.routes.cron_tools import router as cron_tools_router  # noqa: E402
from teage_liu.routes.files import router as files_router  # noqa: E402
from teage_liu.routes.memory import router as memory_router  # noqa: E402
from teage_liu.routes.chat import router as chat_router  # noqa: E402
from teage_liu.routes.schedules import router as schedules_router  # noqa: E402
...
def _create_metrics_collector(config: dict):
    ...
    from teage_liu.monitoring.metrics import MetricsCollector
...
def _create_metrics_store(config: dict, session_logger=None):
    ...
    if not monitoring_cfg.get("daily_persistence", True):
        return None
    try:
        from teage_liu.monitoring.metrics_store import MetricsStore
        storage_cfg = config.get("storage", {})
        sqlite_path = storage_cfg.get("sqlite_path", "data/sessions.db")
...
def _create_approval_manager(config: dict, metrics_collector=None):
    ...
    try:
        from teage_liu.agent.approval import ApprovalManager
...
def _create_task_manager(config: dict):
    ...
    try:
        from teage_liu.tasks.task_manager import TaskManager
...
def _create_stream_manager():
    ...
    from teage_liu.stream_manager import StreamManager
...
def _create_skill_loader():
    ...
    try:
        from teage_liu.skill.loader import SkillLoader
        return SkillLoader()
    except Exception:
        return None
