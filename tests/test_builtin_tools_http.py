...
from teage_liu.agent.tools.web_tools import (
    http_request,
    _classify_quality,
    _extract_domain,
...
class TestQualityPrefix(unittest.TestCase):
    ...
    @patch("teage_liu.agent.tools.web_tools.httpx.Client")
...
class TestAutoRetry(unittest.TestCase):
    ...
    @patch("teage_liu.agent.tools.web_tools._load_domain_state", return_value={})
    @patch("teage_liu.agent.tools.web_tools.httpx.Client")
...
class TestDomainState(unittest.TestCase):
    ...
    @patch("teage_liu.agent.tools.web_tools.httpx.Client")
    @patch("teage_liu.agent.tools.web_tools._load_domain_state")
...
class TestCurlCffiFallback(unittest.TestCase):
    ...
    def setUp(self):
        # 保存原始值
        import teage_liu.agent.tools.web_tools as bt
