...
from hermes.agent.tools.web_tools import (
    http_request,
    _classify_quality,
    _extract_domain,
...
class TestQualityPrefix(unittest.TestCase):
    ...
    @patch("hermes.agent.tools.web_tools.httpx.Client")
...
class TestAutoRetry(unittest.TestCase):
    ...
    @patch("hermes.agent.tools.web_tools._load_domain_state", return_value={})
    @patch("hermes.agent.tools.web_tools.httpx.Client")
...
class TestDomainState(unittest.TestCase):
    ...
    @patch("hermes.agent.tools.web_tools.httpx.Client")
    @patch("hermes.agent.tools.web_tools._load_domain_state")
...
class TestCurlCffiFallback(unittest.TestCase):
    ...
    def setUp(self):
        # 保存原始值
        import hermes.agent.tools.web_tools as bt
