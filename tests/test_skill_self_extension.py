...
from teage_liu.skill.loader import Skill, SkillLoader
...
class TestSkillLifecycle(TestCase):
    ...
    def test_full_lifecycle(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with patch("teage_liu.agent.skill_tools.SKILL_BASE_DIR", tmp), \
                 patch("teage_liu.agent.skill_tools.SKILL_STATE_PATH", tmp / "state.json"):
