...
from teage_liu.agent.tools.file_tools import (  # noqa: E402
    delete_file,
    write_file,
)
from teage_liu.agent.tools import register_builtin_tools  # noqa: E402
...
class TestWriteFileV2WithRegistry(unittest.TestCase):
    ...
    def _make_v2_write_file(self):
        ...
        from teage_liu.agent.tools.file_tools import _register_write_file_v2
...
class TestDeleteFileV2WithRegistry(unittest.TestCase):
    ...
    def _make_v2_delete_file(self):
        ...
        from teage_liu.agent.tools.file_tools import _register_delete_file_v2
