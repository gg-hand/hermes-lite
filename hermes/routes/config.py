...
def _server():
    ...
    """
    return sys.modules.get("hermes.server") or sys.modules.get("server")
        ...
        with _config_write_lock:
            ...
            if not needs_restart:
                try:
                    ...
                    from hermes.container import detect_changed_sections
            ...
            if reloaded_components:
                try:
                    ...
                    from hermes.background_loops import cleanup_loop, file_cleanup_loop, metrics_persist_loop
