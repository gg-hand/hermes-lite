...
async def lifespan(app: FastAPI):
    ...
    """
    from hermes.lifespan import lifespan as _lifespan
...
from hermes.routes.misc import router as misc_router  # noqa: E402
from hermes.routes.health import router as health_router  # noqa: E402
from hermes.routes.sessions import router as sessions_router  # noqa: E402
from hermes.routes.config import router as config_router  # noqa: E402
from hermes.routes.approvals import router as approvals_router  # noqa: E402
from hermes.routes.proposals import router as proposals_router  # noqa: E402
from hermes.routes.skills import router as skills_router  # noqa: E402
from hermes.routes.cron_tools import router as cron_tools_router  # noqa: E402
from hermes.routes.files import router as files_router  # noqa: E402
from hermes.routes.memory import router as memory_router  # noqa: E402
from hermes.routes.chat import router as chat_router  # noqa: E402
from hermes.routes.schedules import router as schedules_router  # noqa: E402
...
def _create_metrics_store(config: dict, session_logger=None):
    ...
    if not monitoring_cfg.get("daily_persistence", True):
        return None
    try:
        from hermes.monitoring.metrics_store import MetricsStore
        storage_cfg = config.get("storage", {})
        sqlite_path = storage_cfg.get("sqlite_path", "data/sessions.db")
...
def _create_skill_loader():
    ...
    try:
        from hermes.skill.loader import SkillLoader
        return SkillLoader()
    except Exception:
        return None
...
def _create_health_checker(orchestrator=None, session_logger=None, mcp_manager=None,
    ...
    """
    try:
        from hermes.monitoring.health import HealthChecker
