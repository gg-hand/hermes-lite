...
try:
    ...
    try:
        from cron_tool_loader import (  # type: ignore
            DEFAULT_BASE_DIR as _CRON_TOOL_BASE_DIR,
            DEFAULT_TIMEOUT as _CRON_TOOL_DEFAULT_TIMEOUT,
            execute_tool as _execute_cron_tool,
        )
    except ImportError:  # pragma: no cover - cron_tool_loader 不可用时降级
        _CRON_TOOL_BASE_DIR = "cron_tool"  # type: ignore
        _CRON_TOOL_DEFAULT_TIMEOUT = 30  # type: ignore
        _execute_cron_tool = None  # type: ignore
